...
use Database\Seeders\CRM\Expense\ExpenseAreaSeeder;
use Database\Seeders\CRM\Expense\ExpenseSeeder;
use Database\Seeders\CRM\Tax\TaxSeeder;
use Database\Seeders\CRM\Invoice\InvoiceSeeder;
...
class DemoDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->truncateMessage(new Tax());
        $this->call(TaxSeeder::class);
        $this->seededMessage(new Tax());

        $this->truncateMessage(new ExpenseArea());
        $this->call(ExpenseAreaSeeder::class);
        $this->seededMessage(new ExpenseArea());

        $this->truncateMessage(new Expense());
        $this->call(ExpenseSeeder::class);
        $this->seededMessage(new Expense());

        $this->truncateMessage(new Invoice());
        $this->call(InvoiceSeeder::class);
        $this->seededMessage(new Invoice());
